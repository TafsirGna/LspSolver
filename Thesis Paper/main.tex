...
et différents types d’opérateurs d’AGs ont été proposés, pour résoudre ces problèmes.
	...
	\begin{table}[h]
		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\textbf{8} & 1473 & 15.039 & . & .\\
			\textbf{9} & 3117 & 25.352 & . & .\\
			\textbf{10} & 1493 & 121.909 & . & . \\
			\hline
		\end{tabular}	
		\caption{Résultats de test sur 10 instances du PSP du HFC-PGA en seconds}	
	\end{table}			
		...
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			\textbf{Instance} & \textbf{Optimal cost} & \textbf{CP time} & \textbf{HCM-PGA time} & \textbf{GAs result gap} \\
			\hline
			\textbf{1} & 1377 & 9.14 & . & . \\
			\textbf{2} & 1447 & 7.292 & . & .\\
			\textbf{3} & 1107 & 2.946 & . & .\\
			...
			\hline
		\end{tabular}	
		\caption{Résultats de test sur 10 instances du PSP du HCM-PGA en seconds}	
	\end{table}			
