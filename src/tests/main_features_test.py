...
# 
    def test_mutation(self):
        ...
        c = Chromosome.createFromIdentifier(stringIdentifier=(0, 2, 0, 2, 3, 1, 2, 1))
    ...
    def test_crossover(self):
        ...
        cA, cB = Chromosome.createFromIdentifier(stringIdentifier=(0, 0, 2, 2, 2, 1, 3, 1)), Chromosome.createFromIdentifier(stringIdentifier=(0, 2, 2, 2, 1, 3, 0, 1))
