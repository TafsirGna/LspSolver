...
class TestMainFeatures:
    ...
    def test_crossover(self):
        ...
        cA, cB = Chromosome.createFromIdentifier(stringIdentifier=(1, 1, 2, 1, 3, 1, 4, 3, 4, 5, 3, 2, 2, 5, 3, 3, 2, 3, 3, 3)), Chromosome.createFromIdentifier(stringIdentifier=(3, 3, 2, 3, 3, 1, 3, 3, 4, 4, 5, 2, 2, 2, 5, 1, 1, 1, 3, 3))
    ...
    def setUpInput(self):
        ...
        inputFile = "data/input/instancesWith20periods/36"
